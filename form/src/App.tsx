...
const App = () => {
  return (
    <div className='bg-gradient-to-r from-blue-900 to-zinc-900 text-white'>
      <div className='flex justify-between'>
        <Menu />
        <div className='flex flex-col p-20 w-full h-screen '>
          <div className='flex justify-between items-center'>
            <h1 className='text-2xl font-semibold text-zinc-300 flex items-center gap-4'>New audience <FontAwesomeIcon className='text-lg' icon={faWandMagicSparkles} /></h1>
          ...
          <div className='flex flex-wrap gap-2 mt-20 '>
            <div className='w-80 outline-none border-2 border-zinc-300 rounded px-2 py-2 flex gap-2'>
              <p>Name: </p>
              <input type="text" placeholder='John Doe  ' className='outline-none w-full bg-transparent' />
            </div>
            <div className='w-80 outline-none border-2 border-zinc-300 rounded px-2 py-2 flex gap-2'>
              <p>Gender </p>
              <select className='outline-none w-full'>
                <option>Male</option>   z
            ...
            <div className='w-40 outline-none border-2 border-zinc-300 rounded px-2 py-2 flex gap-2'>
              <p>Age: </p>
          ...
          <div className='mt-5 flex flex-col'>
            ...
            <div className='flex flex-wrap gap-2 mt-1'>
              ...
              <div className='w-72 outline-none border-2 border-zinc-300 rounded px-2 py-2 flex gap-2'>
                <p>Stream:</p>
                <input type="text" placeholder='Computer Science' className='outline-none w-full' />
              </div>
              <div className='w-80 outline-none border-2 border-zinc-300 rounded px-2 py-2 flex gap-2'>
                <p>Course:</p>
                <input type="text" placeholder='B.Tech' className='outline-none w-full' />
              </div>  
              <div className='w-44 outline-none border-2 border-zinc-300 rounded px-2 py-2 flex gap-2'>
                <p>Semester:</p>
                <input type="number" placeholder='3' className='outline-none w-full' />
              </div> 
            </div>
          </div>
        </div>
